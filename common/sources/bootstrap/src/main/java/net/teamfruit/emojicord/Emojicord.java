...
@Mod(value = Reference.MODID, modid = Reference.MODID, name = Reference.NAME, version = VersionReference.VERSION, guiFactory = Reference.GUI_FACTORY, updateJSON = Reference.UPDATE_JSON)
