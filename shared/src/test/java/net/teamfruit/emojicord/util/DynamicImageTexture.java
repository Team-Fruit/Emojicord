...
public abstract class DynamicImageTexture implements ImageTexture {
	...
	public static @Nonnull DynamicImageTexture create(
	...
	public static class DynamicTexture extends DynamicImageTexture {
		...
		public static @Nonnull DynamicTexture createFromRawData(
				final @Nullable int[] image, final int width,
				final int height
		) {
		...
		public static @Nonnull DynamicTexture createFromImage(
				final @Nonnull BufferedImage image, final int width,
				final int height
		) {
			// return same size
	...
	public static class MipmapDynamicTexture extends DynamicImageTexture {
		...
		private MipmapDynamicTexture(
				final @Nullable int[][] mipdata, final int width, final int height,
				final int miplevel
		) {
			super(width, height);
		...
		public static @Nonnull MipmapDynamicTexture createFromRawMipmap(
				final @Nullable int[][] mipdata,
				final int width, final int height, final int miplevel
		) {
			return new MipmapDynamicTexture(mipdata, width, height, miplevel);
		}

		public static @Nonnull MipmapDynamicTexture createFromRawData(
				final @Nonnull int[] image, final int width,
		...
		public static @Nonnull MipmapDynamicTexture createFromSizedImage(
				final @Nonnull BufferedImage sizedImage,
				final int miplevel
		) {
			final int width = sizedImage.getWidth();
			final int height = sizedImage.getHeight();
		...
		public static @Nonnull MipmapDynamicTexture createFromImage(
				final @Nonnull BufferedImage image, final int width,
				final int height, final int miplevel
		) {
		...
		private static int calcPixel(
				final int pixel1, final int pixel2, final int pixel3, final int pixel4,
		...
		private static int calcClearPixel(
				final int pixel1, final int pixel2, final int pixel3, final int pixel4,
				final int color
		) {
